...
void GenerateAllFuncs() {
  ...
  printf("        INT2FLOAT LF@result LF@arg\n");
  ...
  printf("    TYPE LF@type2 LF@$i\n");
  printf("    TYPE LF@type3 LF@$j\n");
  ...
  printf("    LT LF@bool LF@$j int@0\n");
  printf("    JUMPIFNEQ substring_bad_arg_value LF@bool bool@true\n");
  printf("    GT LF@bool LF@$i LF@$j\n");
  printf("    JUMPIFNEQ substring_bad_arg_value LF@bool bool@true \n");
  printf("    DEFVAR LF@bool2\n");
  printf("    GT LF@bool LF@$i LF@len\n");
  printf("    EQ LF@bool2 LF@$i LF@len\n");
  ...
  printf("    MOVE LF@result string@\n");
  printf("    DEFVAR LF@i\n");
  printf("    MOVE LF@i LF@$i\n");
  printf("    DEFVAR LF@char\n");
  printf("    LABEL substring_loop\n");
  printf("        JUMPIFEQ substring_end LF@i LF@$j\n");
